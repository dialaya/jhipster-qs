...
export class MemberComponent implements OnInit {
  ...
  constructor(protected memberService: MemberService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.members = [];
    ...
    this.memberService
      ...
      .subscribe(
        (res: HttpResponse<IMember[]>) => {
          ...
          this.paginateMembers(res.body, res.headers);
        },
        () => {
          this.isLoading = false;
        }
